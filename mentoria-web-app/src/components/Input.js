import {
    StyledForm, StyledFormDiv, StyledInput, StyledInputforCheck, StyledInputforError, TextoBold, MsgInputError, MsgInputCheck,
        ...
        <>
            ...
            <StyledFormDiv>
                ...
                <StyledForm onSubmit={handleSubmit}>
                    ...
                    />
                    {error && <> <MsgInputError> {error} </MsgInputError>   <ImagemError src={Vector} /> </>}
                    ...
                    {check && <> <MsgInputCheck> <p> {check} </p> </MsgInputCheck>  <ImagemCheck src={correct} /> </>}
